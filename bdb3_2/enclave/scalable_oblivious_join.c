...
void scalable_oblivious_join(elem_t *arr, int length1, int length2, char* output_path){
    ...
    for (int i = 0; i < length; i++) {
        printf("\n%d-th step2 table:%d key:%s data:%s m0:%d m1:%d", i, (1 - arr[i].table_0), arr[i].key, arr[i].data, arr[i].m0, arr[i].m1);
    }
    */
    ...
    for (int i = 0; i < length; i++) {
        printf("\n%d-th step3 table:%d key:%s data:%s m0:%d m1:%d has?%d", i, (1 - arr[i].table_0), arr[i].key, arr[i].data, arr[i].m0, arr[i].m1, arr[i].has_value);
        printf("\n%d-th step3 table:%d key:%s data:%s m0:%d m1:%d has?%d", i, (1 - arr_[i].table_0), arr_[i].key, arr_[i].data, arr_[i].m0, arr_[i].m1, arr_[i].has_value);
    }
    */
    ...
    for (int i = 0; i < length1; i++) {
        printf("\n%d-th arr1 after aggre i k:%s d:%s target i:%d h_v?:%d", i, arr[i].key, arr[i].data, index_target[i], arr[i].has_value);
    }
    for (int i = 0; i < length2; i++) {
        printf("\n%d-th arr2 after aggre i k:%s d:%s target i:%d h_v?:%d", i, arr_[i].key, arr_[i].data, index_target2[i], arr_[i].has_value);
    }
    */
    ...
    for (int i = 0; i < length_result; i++) {
        printf("\n%d-th arr2 key:%s data:%s target index:%d has_value?:%d", i, arr2[i].key, arr2[i].data, index_target2_[i], arr2[i].has_value);
    }
    */
    ...
    printf("\nStep 4 - completed");
        for (int i = 0; i < length_result; i++) {
        printf("\nafter distri %d-th ar2 k:%s d:%s target index:%d has_value?:%d", i, arr2[i].key, arr2[i].data, index_target2_[i], arr2[i].has_value);
    }
    */
    ...
    /*
    for (int i = 0; i < length_result; i++) {
        printf("\nafter dup %d-th ar2 k:%s d:%s has_value?:%d", i, arr2[i].key, arr2[i].data, arr2[i].has_value);
    }
    */
