...
sudo ./host/parallel ./enclave/parallel_enc.signed 36 ~/test1_4.txt ~/test5_4.txt ~/test10_4.txt ~/test50_4.txt | tee -a ~/jan31_result_tab4_fk_tpch.txt;

cd ~/Parallel-join/opaque3;
make clean; make;
./host/parallel ./enclave/parallel_enc.signed 1 ../bdb_data/3_2_0.txt ../bdb_data/3_2_1.txt ../bdb_data/3_2_2.txt | tee -a ~/jan31_result_tab7_opaque_q3.txt;