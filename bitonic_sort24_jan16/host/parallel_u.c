...
enum
{
    parallel_fcn_id_ecall_sort_init = 0,
    parallel_fcn_id_ecall_sort_alloc_arr = 1,
    parallel_fcn_id_ecall_sort_free_arr = 2,
    parallel_fcn_id_ecall_sort_free = 3,
    parallel_fcn_id_ecall_verify_sorted = 4,
    parallel_fcn_id_ecall_start_work = 5,
    parallel_fcn_id_ecall_release_threads = 6,
    parallel_fcn_id_ecall_unrelease_threads = 7,
    parallel_fcn_id_ecall_bitonic_sort = 8,
    parallel_fcn_id_ecall_get_stats = 9,
    parallel_fcn_id_oe_get_sgx_report_ecall = 10,
    parallel_fcn_id_oe_get_report_v2_ecall = 11,
    parallel_fcn_id_oe_verify_local_report_ecall = 12,
    parallel_fcn_id_oe_sgx_init_context_switchless_ecall = 13,
    parallel_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 14,
...
typedef struct _ecall_sort_init_args_t
{
    ...
    int world_size;
    size_t num_threads;
} ecall_sort_init_args_t;

typedef struct _ecall_sort_alloc_arr_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    size_t total_length;
} ecall_sort_alloc_arr_args_t;

typedef struct _ecall_sort_free_arr_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_sort_free_arr_args_t;

typedef struct _ecall_sort_free_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_sort_free_args_t;

typedef struct _ecall_verify_sorted_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ecall_verify_sorted_args_t;
...
typedef struct _ecall_bitonic_sort_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ecall_bitonic_sort_args_t;

typedef struct _ecall_get_stats_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    struct ocall_enclave_stats* stats;
} ecall_get_stats_args_t;
...
oe_result_t parallel_ecall_sort_init(
    ...
    size_t num_threads)
{
    ...
    /* Marshalling struct. */
    ecall_sort_init_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sort_init_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sort_init_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (ecall_sort_init_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_sort_init].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (ecall_sort_init_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(parallel_ecall_sort_init, ecall_sort_init);

oe_result_t parallel_ecall_sort_alloc_arr(
    oe_enclave_t* enclave,
    int* _retval,
    size_t total_length)
{
    ...
    /* Marshalling struct. */
    ecall_sort_alloc_arr_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.total_length = total_length;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sort_alloc_arr_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sort_alloc_arr_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sort_alloc_arr_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_sort_alloc_arr].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sort_alloc_arr_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_sort_alloc_arr, ecall_sort_alloc_arr);

oe_result_t parallel_ecall_sort_free_arr(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_sort_free_arr_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sort_free_arr_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sort_free_arr_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sort_free_arr_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_sort_free_arr].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sort_free_arr_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_sort_free_arr, ecall_sort_free_arr);

oe_result_t parallel_ecall_sort_free(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_sort_free_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sort_free_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sort_free_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sort_free_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_sort_free].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sort_free_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_sort_free, ecall_sort_free);

oe_result_t parallel_ecall_verify_sorted(
    oe_enclave_t* enclave,
    int* _retval)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_verify_sorted_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_verify_sorted_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_verify_sorted_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_verify_sorted_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_verify_sorted].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_verify_sorted_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_verify_sorted, ecall_verify_sorted);
...
oe_result_t parallel_ecall_bitonic_sort(
    oe_enclave_t* enclave,
    int* _retval)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_bitonic_sort_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_bitonic_sort_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_bitonic_sort_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_bitonic_sort_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_bitonic_sort].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_bitonic_sort_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_bitonic_sort, ecall_bitonic_sort);

oe_result_t parallel_ecall_get_stats(
    oe_enclave_t* enclave,
    struct ocall_enclave_stats* stats)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_get_stats_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.stats = (struct ocall_enclave_stats*)stats;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_get_stats_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_get_stats_args_t));
    if (stats)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(struct ocall_enclave_stats));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_get_stats_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_get_stats].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_get_stats_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    OE_READ_OUT_PARAM(stats, 1, sizeof(struct ocall_enclave_stats));
...
OE_WEAK_ALIAS(parallel_ecall_get_stats, ecall_get_stats);
...
enum
{
    ...
    parallel_fcn_id_oe_syscall_epoll_create1_ocall = 10,
    parallel_fcn_id_oe_syscall_epoll_wait_ocall = 11,
    parallel_fcn_id_oe_syscall_epoll_wake_ocall = 12,
    parallel_fcn_id_oe_syscall_epoll_ctl_ocall = 13,
    parallel_fcn_id_oe_syscall_epoll_close_ocall = 14,
    parallel_fcn_id_oe_syscall_open_ocall = 15,
    parallel_fcn_id_oe_syscall_read_ocall = 16,
    parallel_fcn_id_oe_syscall_write_ocall = 17,
    parallel_fcn_id_oe_syscall_readv_ocall = 18,
    parallel_fcn_id_oe_syscall_writev_ocall = 19,
    parallel_fcn_id_oe_syscall_lseek_ocall = 20,
    parallel_fcn_id_oe_syscall_pread_ocall = 21,
    parallel_fcn_id_oe_syscall_pwrite_ocall = 22,
    parallel_fcn_id_oe_syscall_close_ocall = 23,
    parallel_fcn_id_oe_syscall_flock_ocall = 24,
    parallel_fcn_id_oe_syscall_fsync_ocall = 25,
    parallel_fcn_id_oe_syscall_fdatasync_ocall = 26,
    parallel_fcn_id_oe_syscall_dup_ocall = 27,
    parallel_fcn_id_oe_syscall_opendir_ocall = 28,
    parallel_fcn_id_oe_syscall_readdir_ocall = 29,
    parallel_fcn_id_oe_syscall_rewinddir_ocall = 30,
    parallel_fcn_id_oe_syscall_closedir_ocall = 31,
    parallel_fcn_id_oe_syscall_stat_ocall = 32,
    parallel_fcn_id_oe_syscall_fstat_ocall = 33,
    parallel_fcn_id_oe_syscall_access_ocall = 34,
    parallel_fcn_id_oe_syscall_link_ocall = 35,
    parallel_fcn_id_oe_syscall_unlink_ocall = 36,
    parallel_fcn_id_oe_syscall_rename_ocall = 37,
    parallel_fcn_id_oe_syscall_truncate_ocall = 38,
    parallel_fcn_id_oe_syscall_ftruncate_ocall = 39,
    parallel_fcn_id_oe_syscall_mkdir_ocall = 40,
    parallel_fcn_id_oe_syscall_rmdir_ocall = 41,
    parallel_fcn_id_oe_syscall_fcntl_ocall = 42,
    parallel_fcn_id_oe_syscall_ioctl_ocall = 43,
    parallel_fcn_id_oe_syscall_poll_ocall = 44,
    parallel_fcn_id_oe_syscall_kill_ocall = 45,
    parallel_fcn_id_oe_syscall_close_socket_ocall = 46,
    parallel_fcn_id_oe_syscall_socket_ocall = 47,
    parallel_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 48,
    parallel_fcn_id_oe_syscall_socketpair_ocall = 49,
    parallel_fcn_id_oe_syscall_connect_ocall = 50,
    parallel_fcn_id_oe_syscall_accept_ocall = 51,
    parallel_fcn_id_oe_syscall_bind_ocall = 52,
    parallel_fcn_id_oe_syscall_listen_ocall = 53,
    parallel_fcn_id_oe_syscall_recvmsg_ocall = 54,
    parallel_fcn_id_oe_syscall_sendmsg_ocall = 55,
    parallel_fcn_id_oe_syscall_recv_ocall = 56,
    parallel_fcn_id_oe_syscall_recvfrom_ocall = 57,
    parallel_fcn_id_oe_syscall_send_ocall = 58,
    parallel_fcn_id_oe_syscall_sendto_ocall = 59,
    parallel_fcn_id_oe_syscall_recvv_ocall = 60,
    parallel_fcn_id_oe_syscall_sendv_ocall = 61,
    parallel_fcn_id_oe_syscall_shutdown_ocall = 62,
    parallel_fcn_id_oe_syscall_setsockopt_ocall = 63,
    parallel_fcn_id_oe_syscall_getsockopt_ocall = 64,
    parallel_fcn_id_oe_syscall_getsockname_ocall = 65,
    parallel_fcn_id_oe_syscall_getpeername_ocall = 66,
    parallel_fcn_id_oe_syscall_getaddrinfo_open_ocall = 67,
    parallel_fcn_id_oe_syscall_getaddrinfo_read_ocall = 68,
    parallel_fcn_id_oe_syscall_getaddrinfo_close_ocall = 69,
    parallel_fcn_id_oe_syscall_getnameinfo_ocall = 70,
    parallel_fcn_id_oe_syscall_nanosleep_ocall = 71,
    parallel_fcn_id_oe_syscall_clock_nanosleep_ocall = 72,
    parallel_fcn_id_oe_syscall_getpid_ocall = 73,
    parallel_fcn_id_oe_syscall_getppid_ocall = 74,
    parallel_fcn_id_oe_syscall_getpgrp_ocall = 75,
    parallel_fcn_id_oe_syscall_getuid_ocall = 76,
    parallel_fcn_id_oe_syscall_geteuid_ocall = 77,
    parallel_fcn_id_oe_syscall_getgid_ocall = 78,
    parallel_fcn_id_oe_syscall_getegid_ocall = 79,
    parallel_fcn_id_oe_syscall_getpgid_ocall = 80,
    parallel_fcn_id_oe_syscall_getgroups_ocall = 81,
    parallel_fcn_id_oe_syscall_uname_ocall = 82,
    parallel_fcn_id_oe_get_supported_attester_format_ids_ocall = 83,
    parallel_fcn_id_oe_get_qetarget_info_ocall = 84,
    parallel_fcn_id_oe_get_quote_ocall = 85,
    parallel_fcn_id_oe_get_quote_verification_collateral_ocall = 86,
    parallel_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 87,
    parallel_fcn_id_oe_verify_quote_ocall = 88,
    parallel_fcn_id_oe_sgx_get_cpuid_table_ocall = 89,
    parallel_fcn_id_oe_sgx_backtrace_symbols_ocall = 90,
    parallel_fcn_id_oe_sgx_log_backtrace_ocall = 91,
    parallel_fcn_id_oe_sgx_thread_wake_wait_ocall = 92,
    parallel_fcn_id_oe_sgx_wake_switchless_worker_ocall = 93,
    parallel_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 94,
    parallel_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 95,
    parallel_fcn_id_oe_verify_tdx_quote_ocall = 96,
