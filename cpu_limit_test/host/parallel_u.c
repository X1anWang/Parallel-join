...
enum
{
    ...
    parallel_fcn_id_ecall_start_sort_work = 5,
    ...
    parallel_fcn_id_ecall_ojoin_init = 10,
    parallel_fcn_id_ecall_ojoin_alloc_arr = 11,
    parallel_fcn_id_ecall_ojoin_free_arr = 12,
    parallel_fcn_id_ecall_ojoin_free = 13,
    parallel_fcn_id_ecall_verify_joined = 14,
    parallel_fcn_id_ecall_start_work = 15,
    parallel_fcn_id_ecall_scalable_oblivious_join = 16,
    parallel_fcn_id_ecall_cpu_computations_limit = 17,
    parallel_fcn_id_oe_get_sgx_report_ecall = 18,
    parallel_fcn_id_oe_get_report_v2_ecall = 19,
    parallel_fcn_id_oe_verify_local_report_ecall = 20,
    parallel_fcn_id_oe_sgx_init_context_switchless_ecall = 21,
    parallel_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 22,
...
typedef struct _ecall_start_sort_work_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_start_sort_work_args_t;
...
typedef struct _ecall_ojoin_alloc_arr_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _ecall_verify_joined_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ecall_verify_joined_args_t;
...
typedef struct _ecall_cpu_computations_limit_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    long long* size_ptr;
} ecall_cpu_computations_limit_args_t;
...
oe_result_t parallel_ecall_start_sort_work(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_start_sort_work_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_start_sort_work_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_start_sort_work_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_start_sort_work_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_start_sort_work].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_start_sort_work_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_start_sort_work, ecall_start_sort_work);
...
oe_result_t parallel_ecall_ojoin_alloc_arr(
    oe_enclave_t* enclave,
    int* _retval,
    int total_length,
    int key_scope)
{
    ...
    /* Marshalling struct. */
    ecall_ojoin_alloc_arr_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    memset(&_args, 0, sizeof(_args));
    _args.total_length = total_length;
    _args.key_scope = key_scope;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ojoin_alloc_arr_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ojoin_alloc_arr_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ojoin_alloc_arr_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_ojoin_alloc_arr].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ojoin_alloc_arr_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_ojoin_alloc_arr, ecall_ojoin_alloc_arr);
...
oe_result_t parallel_ecall_verify_joined(
    oe_enclave_t* enclave,
    int* _retval)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_verify_joined_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_verify_joined_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_verify_joined_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_verify_joined_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_verify_joined].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_verify_joined_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_verify_joined, ecall_verify_joined);
...
oe_result_t parallel_ecall_cpu_computations_limit(
    oe_enclave_t* enclave,
    long long* size_ptr)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_cpu_computations_limit_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.size_ptr = (long long*)size_ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_cpu_computations_limit_args_t));
    if (size_ptr)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(long long));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_cpu_computations_limit_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_cpu_computations_limit_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (size_ptr)
        OE_WRITE_IN_PARAM(size_ptr, 1, sizeof(long long), long long*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _parallel_ecall_info_table[parallel_fcn_id_ecall_cpu_computations_limit].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_cpu_computations_limit_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(parallel_ecall_cpu_computations_limit, ecall_cpu_computations_limit);
