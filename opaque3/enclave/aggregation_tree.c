...
void aggregation_tree_dup_1_downward(void *voidargs) {
    ...
    */
    ...
    while(cur_tree_node % 2 == 0 && 0 < cur_tree_node) {
        ...
        */
        tree_node_2[temp].k_l = condition * tree_node_2[cur_tree_node].k_l + !condition * tree_node_2[cur_tree_node].k_l;
        tree_node_2[temp].k_l = !condition * tree_node_2[cur_tree_node - 1].k_l + condition * tree_node_2[temp].k_l;
    ...
    while(cur_tree_node < order_thread) {
        ...
        */
        ...
        tree_node_2[temp].k_p = condition * tree_node_2[temp1].k_l + !condition * tree_node_2[temp].k_p;
        tree_node_2[temp].k_p = !condition * tree_node_2[cur_tree_node].k_p + condition * tree_node_2[temp].k_p;
