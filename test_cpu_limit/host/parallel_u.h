...
oe_result_t ecall_sort_alloc_arr(
    oe_enclave_t* enclave,
    int* _retval,
    size_t total_length);

oe_result_t ecall_sort_free_arr(oe_enclave_t* enclave);

oe_result_t ecall_sort_free(oe_enclave_t* enclave);

oe_result_t ecall_verify_sorted(
    oe_enclave_t* enclave,
    int* _retval);

oe_result_t ecall_start_sort_work(oe_enclave_t* enclave);

oe_result_t ecall_release_threads(oe_enclave_t* enclave);

oe_result_t ecall_unrelease_threads(oe_enclave_t* enclave);

oe_result_t ecall_bitonic_sort(
    oe_enclave_t* enclave,
    int* _retval);

oe_result_t ecall_get_stats(
    oe_enclave_t* enclave,
...
oe_result_t ecall_ojoin_alloc_arr(
    oe_enclave_t* enclave,
    int* _retval,
    int total_length,
    int key_scope);
...
oe_result_t ecall_verify_joined(
    oe_enclave_t* enclave,
    int* _retval);
...
oe_result_t ecall_cpu_computations_limit(
    oe_enclave_t* enclave,
    long long* size_ptr);
