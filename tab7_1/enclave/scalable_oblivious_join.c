...
void scalable_oblivious_join(elem_t *arr, long long length1, long long length2, char* output_path){
    ...
    init_time();
    elem_t *arr1 = calloc(MAX_LENGTH, sizeof(*arr1));
    elem_t *arr2 = calloc(MAX_LENGTH, sizeof(*arr2));
    long long *index_target_ = calloc(MAX_LENGTH, sizeof(*index_target_));
    long long *index_target2_ = calloc(MAX_LENGTH, sizeof(*index_target2_));
