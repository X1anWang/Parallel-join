...
void scalable_oblivious_join(elem_t *arr, long long length1, long long length2, char* output_path){
    ...
    */
    ...
    long long *index_target_ = malloc(length_result * sizeof(*index_target_));
    long long *index_target2_ = malloc(length_result * sizeof(*index_target2_));
    oe_mallinfo_t info4;
