...
enum
{
    ...
    parallel_fcn_id_oe_get_sgx_report_ecall = 17,
    parallel_fcn_id_oe_get_report_v2_ecall = 18,
    parallel_fcn_id_oe_verify_local_report_ecall = 19,
    parallel_fcn_id_oe_sgx_init_context_switchless_ecall = 20,
    parallel_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 21,
