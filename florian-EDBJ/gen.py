...
#power_list = [19]
power_list = [16, 18, 20, 22, 24, 26, 28, 30] # with same length output & power law
...
for i in power_list:
    ...
    file.write("\n")
    file.write(str(8)+" "+str(random.randint(1, 100))+"\n")
    for o in range(pow(2,i-1) - 1):
        file.write(str(8)+" "+str(random.randint(1, 100))+"\n")
    file.write("\n")
    for o in range(pow(2,i-1)):
        file.write(str(o+1)+" "+str(random.randint(1, 100))+"\n")
    file.close
    print(name + " ", end = "")
