...
void scalable_oblivious_join(elem_t *arr, long long length1, long long length2, char* output_path){
    ...
    printf("\nBitonic sort based parallel foreign key join start...");
    ...
    long long length_result = 0;
    index_target = calloc(1, sizeof(*index_target));
    index_target2 = calloc(length2, sizeof(*index_target2));
    long long *sum_t0 = calloc(number_threads, sizeof(*sum_t0));
    bitonic_init();
    init_time2();
    init_time();
    ...
    */
    ...
    for (long long i = 0; i < number_threads; i++) {
        ...
        soj_scan_1_args_[i].sum = sum_t0 + i;
    ...
    */
    ...
    //long long *index_target_ = calloc(length_result, sizeof(*index_target_));
    long long *index_target2_ = calloc(length_result, sizeof(*index_target2_));
    ...
    */
    ...
    printf("\nresult length is:%lld\n",length_result);
    for (long long i = 0; i < length_result; i++) {
        long long key1 = arr[i].key;
        ...
        long long data_len1 = my_len(arr[i].data);
